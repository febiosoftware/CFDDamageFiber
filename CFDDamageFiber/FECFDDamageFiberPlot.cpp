...
FEPlotCFDDamagedFiberDamageAvg::FEPlotCFDDamagedFiberDamageAvg(FEModel* pfem) : FEPlotDomainData(pfem, PLT_FLOAT, FMT_ITEM)
{

}

bool FEPlotCFDDamagedFiberDamageAvg::Save(FEDomain& dom, FEDataStream& a)
{
	FEMaterial* pm = dom.GetMaterial();
	if (pm == nullptr) return false;
